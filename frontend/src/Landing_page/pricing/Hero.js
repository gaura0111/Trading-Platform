    ...
    return ( 
       <div className='container mb-3'>
        <div className='row mt-5  p-5 text-center border-bottom'>
            <h1 clas>Pricing</h1>
            <p className='mt-4 fs-4 text-muted'>Free equity investments and flat â‚¹20 traday and F&O trades</p>
        ...
        <div className='row text-center'>
            ...
            <h1 className='text-center mb-3 fs-2'>Free equity delivery</h1>
                <p className='text-center mt-3 text-muted mb-5'>All equity delivery investments (NSE, BSE)<br></br> are absolutely free â€” â‚¹
            0 brokerage.</p>
            ...
            <h1 className='text-center mb-3 fs-2'>Free direct MF</h1>
                <p className='text-center mt-3 text-muted mb-5'>All direct mutual fund investments are absolutely free â€” â‚¹ 0
